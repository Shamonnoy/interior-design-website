    ...
    return (
        <div ref={aboutRef} className="about container py-[8%] mx-auto section-container px-4 gap-14">
            ...
            <div className="about-content w-full lg:w-1/2">
                <span className="title-span">Architectural Philosophy</span>
                <h2 className="heading-1 mb-5">
                    <span className="text-coffee">Bespoke Living Spaces </span> <br />
                    Engineered with Soul & Precision
                </h2>
                <p className="pera-text leading-relaxed">
                    At Aura Studio, we believe architecture is the art of curating emotional experience through light, texture, and proportion. Our design practice combines minimalist modernism with tactile warmth to create environments that enrich everyday rituals.
                </p>
