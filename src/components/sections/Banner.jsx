    ...
    return (
        <>
            <div className="container py-20 mx-auto px-4">
                ...
                >
                    <div className="overlay absolute inset-0 bg-black/20 hover:bg-black/40 transition duration-300"></div>
                    <div className="absolute inset-0 flex justify-center items-center">
                        <div
                            ref={playRef}
                            className="play border w-28 h-28 flex justify-center items-center border-white rounded-full text-white uppercase tracking-widest cursor-pointer hover:bg-white hover:text-black transition duration-300"
                        >
                            play
                        </div>
                    </div>
