        ...
        <div ref={featureRef} className="bg-light-yellow">
            <div className="container py-[8%] mx-auto px-4 space-y-10">
                <div className="feature-content section-container lg:items-center!">
                    <div>
                        <span className="title-span">Design Disciplines</span>
                        <h2 className="heading-1 mb-5">
                            <span className="text-coffee">Tailored spatial concepts </span> <br />
                            for refined residences
                        </h2>
                        <p className="pera-text">
                            From acoustic planning and architectural lighting to bespoke millwork, our multidisciplinary team elevates every dimension of interior architecture.
                        </p>
                    </div>
