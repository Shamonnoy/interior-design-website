        ...
        <>
            ...
            <div ref={aboutRef} className='container py-[8%] mx-auto px-4 gap-14 section-container items-center!'>
                ...
                <div className="about-content w-full lg:w-1/2">
                    <span className="title-span">Studio Heritage</span>
                    <h2 className="heading-1 mb-5">
                        <span className="text-coffee">Timeless elegance </span> <br />
                        tailored to modern lifestyles
                    </h2>
                    <p className="pera-text">
                        Founded on principles of sculptural simplicity and refined materiality, Aura Studio envisions spaces that balance serene minimalism with tactile comfort and everyday usability.
                    </p>
                    <ul className='space-y-2 mb-10 text-muted'>
                        <li><span>Design Consultations: Mon - Fri (09:30 - 18:30)</span></li>
                        <li><span>Private Gallery Viewings: Saturday by appointment</span></li>
                    </ul>
                    <MainBtn path="/shop" text={"Explore Collection"} className="bg-black! text-white!" />
                </div>
            </div>
