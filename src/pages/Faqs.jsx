        ...
        <>
            ...
            <div ref={faqRef} className="container py-[8%] mx-auto px-4 section-container items-center! gap-10 lg:gap-14">
                ...
                <div className="faq-content w-full lg:w-1/2">
                    <FAQItem
                        question="What is the standard architectural project timeline?"
                        answer="A standard full-scope residential project typically takes 8 to 16 weeks for design development, 3D visualizations, and municipal approvals, followed by construction and turnkey fit-out tailored to project scale."
                        isOpen={openIndex === 0}
                        onClick={() => toggleFAQ(0)}
                    />
                    <FAQItem
                        question="How do we initiate the design process?"
                        answer="We begin with an in-depth spatial discovery session to define your aesthetic preferences, functional priorities, and budget. From there, our studio develops schematic sketches and mood boards for your approval."
                        isOpen={openIndex === 1}
                        onClick={() => toggleFAQ(1)}
                    />
                    <FAQItem
                        question="Do you offer on-site supervision and contractor management?"
                        answer="Yes. We offer complete turnkey project administration, coordinating directly with general contractors, lighting engineers, and millwork fabricators to ensure exact adherence to architectural drawings."
                        isOpen={openIndex === 2}
                        onClick={() => toggleFAQ(2)}
                    />
                    <FAQItem
                        question="Can you source custom, one-of-a-kind furniture and materials?"
                        answer="Absolutely. We maintain direct relationships with premier European quarries, artisan joinery workshops, and boutique textile ateliers to design and manufacture bespoke pieces tailored exclusively to your space."
                        isOpen={openIndex === 3}
                        onClick={() => toggleFAQ(3)}
                    />
                </div>
