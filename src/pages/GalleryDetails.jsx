            ...
            <div ref={galleryRef} className="container mx-auto px-4 py-[8%]">
                ...
                <div className="section-container p-0! gap-10 lg:gap-14">
                    ...
                    >
                        ...
                        <h3 className="text-3xl lg:text-4xl font-semibold pt-8 pb-5">{gallery.title || "Custom Architectural Millwork"}</h3>
                        <p className="text-paragraph pb-8 leading-relaxed">
                            Every element within this gallery series illustrates our dedication to spatial fluidity and tectonic clarity. By engineering customized timber partitions and flush-mounted acoustic transitions, each room achieves effortless versatility.
                        </p>

                        <div className="centered-row justify-between flex-col lg:flex-row gap-3 w-full h-auto lg:h-90">
                            <div className="image group overflow-hidden rounded-sm h-full w-full shadow-sm">
                                <img src={gallery.image2} alt="Architectural framing" className="section-image group-hover:scale-105 transition-all duration-700" />
                            </div>
                            <div className="image group overflow-hidden rounded-sm h-full w-full shadow-sm">
                                <img src={gallery.image3} alt="Material detail" className="section-image group-hover:scale-105 transition-all duration-700" />
                            </div>
                        </div>

                        <p className="text-paragraph py-8 leading-relaxed">
                            Natural daylight filtering through fluted timber louvers creates dynamic shadow play across the living spaces, imbuing the residence with calm, meditative energy throughout the day.
                        </p>
