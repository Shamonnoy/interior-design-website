        ...
        <>
            ...
            <div ref={aboutRef} className='container py-[8%] mx-auto px-4 gap-14 section-container items-center!'>
                ...
                <div className="about-content w-full lg:w-1/2">
                    <span className="title-span">Architectural Services</span>

                    <h2 className="heading-1 mb-5">
                        <span className="text-coffee">We craft bespoke</span> <br />
                        architectural interiors
                    </h2>

                    <span className="text-xl lg:text-2xl font-medium block pb-8">High-fidelity 3D visualization and turnkey project execution</span>
                    <p className="pera-text">
                        From initial spatial diagrams and material sample boards to final construction detailing, our studio manages every project stage with uncompromising precision.
                    </p>

                    <div className="centered-row gap-8">
                        <MainBtn path="/about" text={"Studio Story"} className="bg-black! text-white!" />
            ...
            <div ref={serviceRef} className="container py-[8%] mx-auto px-4 gap-10 lg:gap-14">
                <div className="text-center w-full mb-10 content">
                    <span className="title-span">Holistic Capabilities</span>
                    <h2 className="heading-1 mb-5">
                        Our services make your <br />
                        <span className="text-coffee"> living spaces extraordinary </span>
                    </h2>
                </div>
            ...
            <div ref={ctaRef} className="bg-primary text-white">
                <div className="container section-container mx-auto px-4 py-[4%] gap-8 lg:gap-10 content">
                    <h2 className="text-xl sm:text-2xl lg:text-3xl max-w-2xl font-medium">Ready to discuss your dream project or request a comprehensive design consultation?</h2>

                    <MainBtn path="/contact" text={"Book Consultation"} />
                </div>
            </div>
            ...
            <div ref={storeRef} className="container py-[8%] mx-auto px-4 section-container items-center! gap-10 lg:gap-14">
                <div className="faq-image w-full lg:w-1/2 centered-row sm:flex-row flex-col gap-5 h-auto sm:h-90 xl:h-120">
                    <img src={faqImage1} alt="Bespoke interior design showcase" className="section-image rounded-sm shadow-lg" />
                    <img src={faqImage2} alt="Architectural lighting and finishes" className="section-image rounded-sm shadow-lg" />
                </div>

                <div className="content w-full lg:w-1/2">
                    <span className="title-span">Custom Furniture & Decor</span>

                    <h2 className="heading-1 mb-5">
                        Timeless, handcrafted
                        <span className="text-coffee"> collector pieces </span> <br />
                    </h2>

                    <p className="pera-text">
                        Explore our studio catalog featuring limited-edition armchairs, architectural luminaires, and bespoke marble tables crafted by master artisans.
                    </p>

                    <MainBtn path="/shop" text={"Explore Shop Collection"} className="bg-black! text-white! w-60!" />
                ...
                <div className="feature-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 text-center">
                    <div className="group">
                        ...
                        <p className="text-gray-600 mb-6 max-w-xs mx-auto text-sm">
                            Seamless delivery and on-site positioning anywhere in the world.
                        </p>
                    ...
                    <div className="group">
                        ...
                        <h3 className="text-xl lg:text-2xl font-semibold mb-3">
                            Certified Material Authenticity
                        </h3>

                        <p className="text-gray-600 mb-6 max-w-xs mx-auto text-sm">
                            100% genuine Italian leather, Carrara marble, and FSC-certified hardwoods.
                        </p>
                    ...
                    <div className="group">
                        ...
                        <p className="text-gray-600 mb-6 max-w-xs mx-auto text-sm">
                            A single point of contact for consultations, styling, and revisions.
                        </p>
                    </div>
                </div>
            </div>
