                ...
                <div className="container mx-auto px-4 section-container gap-10 lg:gap-14">
                    ...
                    <div className="product-content w-full lg:w-1/2">
                        ...
                        <p className="text-muted font-light pb-5 leading-relaxed">
                            {product.description || "Individually handcrafted by master artisans using premium sustainable materials. Each curve and seam is balanced to ensure structural stability and enduring aesthetic appeal."}
                        </p>
                        <p className="text-muted font-light pb-10 leading-relaxed">
                            Featuring ergonomic contouring, hand-finished surfaces, and custom hardware. Designed to integrate seamlessly into both minimalist modern residences and layered transitional interiors.
                        </p>
