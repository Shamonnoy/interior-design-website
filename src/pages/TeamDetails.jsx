            ...
            <div ref={teamRef} className="container py-[8%] mx-auto px-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-10 mb-10">
                    ...
                    <div className="team-content">
                        ...
                        <p className="text-paragraph leading-relaxed pb-8">
                            Dedicated to curating spaces that unite timeless proportion with contemporary functionality. Specializing in bespoke residential concepts and architectural millwork detailing.
                        </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-10">
                    <div className="team-about">
                        <h3 className="text-2xl sm:text-3xl lg:text-4xl font-medium pb-3">Biography</h3>
                        <p className="pb-5 text-paragraph leading-relaxed">
                            With extensive background across high-end residential renovations and commercial architectural planning, our design leaders ensure each project is executed to the highest international standards.
                        </p>

                        <p className="text-paragraph pb-8 leading-relaxed">
                            Believing that sustainable longevity is the cornerstone of luxury, they integrate locally sourced natural materials with state-of-the-art construction methodologies.
                        </p>

                        <MainBtn text={"Schedule Consultation"} path="/contact" className="bg-black! text-white! rounded-sm! shadow-none!" />
                    </div>
